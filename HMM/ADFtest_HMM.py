...
os.chdir("C:/Users/cogus/Documents/seminar2025/HMM")
print(os.getcwd())
...
df = pd.read_csv("DlogPrepData_HMM(merged).csv")


# In[9]:


# ADF 검정용 윈도우 구간 준비 (15일짜리로, 롤링 윈도우)
...
# ADF 테스트 + Granger (lag=1만) + 결과 테이블 생성
...
df_results.to_csv("HMM_ADF_results.csv", index=False)
